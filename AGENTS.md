...
|-------|---------|---------|
| roster-run | 1.10.2 | Classifies an incoming task and routes it to the right pipeline skill |
...
| roster-review | 2.2.1 | Performs a fix-first code review with conditional specialists and a GO/NO-GO verdict |
| roster-qa | 1.8.1 | Runs deterministic quality gates and produces a GO/NO-GO verdict |
