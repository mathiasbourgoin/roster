...
| roster-spec | 2.3.0 | Derives an adversarial, GWT-scenario spec with formalized FR-NNN requirements from an intake brief |
...
| roster-review | 1.8.0 | Performs a fix-first code review with conditional specialists and a GO/NO-GO verdict |
