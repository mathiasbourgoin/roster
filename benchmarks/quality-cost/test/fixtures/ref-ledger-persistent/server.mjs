// PERSISTENT correct reference — stores accounts in a JSON file at $DATA_FILE,
// reloaded on each start. Used to prove the harness survives stage restarts
// against a durable store WITHOUT false regressions (review C1). Behaviorally
// identical to ref-ledger; only the storage is durable.
...
function save(accounts) {
  fs.writeFileSync(DATA_FILE, JSON.stringify(Object.fromEntries(accounts)));
}
const accounts = load();
